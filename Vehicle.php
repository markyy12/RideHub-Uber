...
<section class="vehicles">
      ...
      <div class="uber-car-icon">
        ...
        <h1 class="text-center fw-bold">Vehicles</h1>
        <div class="flex">
          <a href="index.html">Home</a>
          <span>></span>
          <a href="" id="flex">Vehicles</a>
        </div>
      </div>
    </section>
      ...
      <div class="container-lg">
        <div class="row gap-3">
          <div class="col border p-4">
            <img src="./Image/Sudan.webp" alt="" width="300px" loading="lazy" />
            <h5>Sedan</h5>
          </div>
          <div class="col border p-4">
            <img src="./Image/Suzuki.jpg" alt="" width="250px" loading="lazy" />
            <h5>Suzuki</h5>
          </div>
          <div class="col border p-4">
            <img src="./Image/Van.jpg" alt="" width="300px" loading="lazy" />
            <h5>Suzuki Van</h5>
          </div>
        </div>
        <div class="row gap-3 py-3">
          <div class="col border p-4">
            <img src="./Image/SUV.jpg" alt="" width="300px" loading="lazy" />
            <h5>SUV</h5>
          </div>
          <div class="col border p-4">
            <img src="./Image/Bike.jpg" alt="" width="250px" loading="lazy" />
            <h5>Bike</h5>
          </div>
          <div class="col border p-4">
            <img
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <ul class="social-icons">
              <li>
                <a href="https://www.instagram.com/markyy_ij?igsh=M3RieWtkZnZ6anlh" class="instagram"><i class="bi bi-instagram"></i></a>
              </li>
              <li>
                <a href="https://x.com/AIA_ijaiya?t=RV9rd1gFYhQf8jTwtTb9fQ&s=09" class="twitter"><i class="bi bi-twitter-x"></i></a>
              </li>
              <li>
