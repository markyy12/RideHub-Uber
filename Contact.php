    ...
    <section class="contact">
      <div class="container-lg">
        <div class="row gap-3 p-4">
          <div class="col border p-3 rounded-4 text-center">
            <i class="bi bi-geo-alt" id="geo"></i>
            <h4>Office Location</h4>
            <p class="text muted">
              Behind Police Force Barrack, Offa, Kwara State.
            </p>
          </div>
          <div class="col border p-3 rounded-4 text-center">
            <i class="bi bi-envelope-at-fill" id="mail"></i>
            <h4>@ridehub@gmail.com</h4>
            <p>Email us anytime for anykind of queries.</p>
          </div>
          <div class="col border p-3 rounded-4 text-center">
            <i class="bi bi-telephone-outbound" id="num"></i>
            <h4>+234 806 573 6505</h4>
            <p>Call us anytime for anykind, of enquiries.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container-lg">
        <div class="row mt-5 d-flex flex-md-row flex-column">
          ...
          <div class="col" id="contact-text">
            <h3>Contact Us</h3>
            <form
              action="https://formspree.io/f/mpweywnj"
              class="row g-3 p-4"
              method="POST"
              id="my-form"
            >
